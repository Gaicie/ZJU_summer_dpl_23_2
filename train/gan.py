...
os.makedirs("result/gan_images", exist_ok=True)
os.makedirs("result/gan_models", exist_ok=True)
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], "result/gan_images/%d.png" % batches_done, nrow=5, normalize=True)

torch.save(generator.state_dict(), "result/gan_models/generator.pth")
torch.save(discriminator.state_dict(), "result/gan_models/discriminator.pth")
